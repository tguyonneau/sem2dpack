...
ISS = Input('PARAM_GEN/OUTPUT/Par.inp')

# Set general parameters
ISS.set_general_parameters(iexec=1, ngll=5, fmax=10., ndof=2, verbose='1111', ItInfo=100000)
...
write_stations_file('PARAM_GEN/OUTPUT/stations', X, Z)
